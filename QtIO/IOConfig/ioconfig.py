...
class Ui_IOConfig(object):
    def setupUi(self, IOConfig):
        ...
        self.nomLabel_2 = QtWidgets.QLabel(IOConfig)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Maximum, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.nomLabel_2.sizePolicy().hasHeightForWidth())
        self.nomLabel_2.setSizePolicy(sizePolicy)
        self.nomLabel_2.setAlignment(QtCore.Qt.AlignCenter)
        self.nomLabel_2.setObjectName("nomLabel_2")
        self.nameHorLay.addWidget(self.nomLabel_2)
        self.nomLine_3 = QtWidgets.QLineEdit(IOConfig)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.nomLine_3.sizePolicy().hasHeightForWidth())
        self.nomLine_3.setSizePolicy(sizePolicy)
        self.nomLine_3.setObjectName("nomLine_3")
        self.nameHorLay.addWidget(self.nomLine_3)
    ...
    def retranslateUi(self, IOConfig):
        ...
        self.nomLabel_2.setText(_translate("IOConfig", "Nom"))
