import sys, config_ui, main, config_interpreter
        ...
        if state == 'reset':
            ...
            for out in state:
                if out in ["rect", "ellipse"]:
                    ...
                    if type(state[out]).__name__ in ["tuple", "list"]:  # si on a une couleur à mettre
...
class Ui_mainWindow(object):
    ...
    def setupUi(self, mainWindow):
        ...
        self.label_9.setPixmap(QtGui.QPixmap(os.getcwd() + "/logo.png"))
